    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Processor</h1>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-gray-800">Daftar Processor</h6>
                            </div>
                            <div class="card-body">
                                <form id="regForm" action="process_form.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="processor" class="form-control" id="processor"
                                               required>
                                        <br>
                                        <button type="submit" name="form_type" value="processor"
...
<!--                                                    </a>-->
<!--                                                </td>-->
                                        <?php foreach ($cpu_data as $index => $cpu): ?>
                                            <tr>
                                                <td><?= $index+1 ?></td>
                                                <td><?=$cpu['NAME_PARAMETER']?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
